...
public class SlimeObjectUnit : ObjectUnit
{
    ...
    private void ApplyBounceEffect(Collider[] cols)
    {
        ...
        List<ObjectUnit> targetObjList = new List<ObjectUnit>();
        ...
        foreach (var col in cols)
        {
            if (col != null)
                ...
                {
                    if(col.Equals(Collider)) continue;
                    targetObjList.Add(unit);
                }
        }
    ...
    private void ShowBounceEffect(Action Callback = null)
    {
