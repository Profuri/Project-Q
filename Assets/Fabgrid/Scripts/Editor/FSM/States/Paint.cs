...
namespace Fabgrid
{
    public class Paint : State
    {
        ...
        {
            eventHandler.ProcessEvents(Event.current, currentTool);
        ...
        {
            AssetPreview.SetPreviewTextureCacheSize(buttonTilePairs.Count + 1);
        ...
        private void RegisterEvents()
        {
            ...
            eventHandler.OnMouseDown.Add(nameof(OnMouseDown), OnMouseDown);
        }

        private void UnregisterEvents()
        {
            eventHandler.OnMouseDown.Remove(nameof(OnMouseDown));
            eventHandler.OnSceneGUI -= OnSceneGUI;
            eventHandler.OnMouseMove -= OnMouseMove;
            eventHandler.OnKeyDown -= OnKeyDown;
        }
        ...
        private void RemoveNullTiles()
        {
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                tilemap.instantiatedTilePositions.Add(tilemap.transform.GetChild(i).gameObject.transform.position);
            }
        }
